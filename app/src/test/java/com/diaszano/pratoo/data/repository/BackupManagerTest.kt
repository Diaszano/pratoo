...
class BackupManagerTest {
    ...
    @Test
    fun `save recipe with favorite persists favorite state`() =
        runTest {
            val id =
    ...
    @Test
    fun `save recipe with tags persists tag associations`() =
        runTest {
            val id =
                repository.saveRecipe(
    ...
    @Test
    fun `getAllRecipes returns complete recipes`() =
        runTest {
            repository.saveRecipe(
                Recipe(
                    title = "R1",
    ...
    @Test
    fun `codec encode and decode preserves recipes`() =
        runTest {
            val recipes =
                listOf(
                    Recipe(
    ...
    @Test
    fun `codec validates imported data`() =
        runTest {
            val recipes =
                listOf(
                    Recipe(
    ...
    @Test
    fun `delete all recipes clears backup`() =
        runTest {
